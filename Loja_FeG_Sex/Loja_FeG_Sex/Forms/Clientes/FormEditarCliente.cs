...
namespace Loja_FeG_Sex.Forms.Clientes
{
    public partial class FormEditarCliente : Form
    {
        ...
        private void btn_Confirmar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    var sexo = rd_Fem.Checked ? "F" : "M";

                    //var situacao = rd_Ativo.Checked || rd_Desativo.Checked;
                    bool situacao;
                    if (rd_Ativo.Checked)
                        situacao = true;
                    else
                    ...
                    entidades.IdCliente = (cb_Cliente.SelectedItem as ClientesVo).IdCliente;
                    entidades.Nome = txt_Nome.Text;
                    entidades.Email = txt_Email.Text;
                    entidades.Sexo = sexo;
                    entidades.Celular = long.Parse(msk_Celular.Text);
                    entidades.Telefone = msk_Telefone.TextLength > 0 ? long.Parse(msk_Telefone.Text) : 0;
                    ...
                    entidades.Numero = txt_Numero.TextLength > 0 ? int.Parse(txt_Numero.Text) : 0;
                    entidades.Complemento = txt_Complemento.Text;
                    entidades.Ativo = situacao;

                    var sex = sexo == "M" ? "Masculino" : "Feminino";
        ...
        private void cb_Cliente_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                txt_Bairro.Text = (cb_Cliente.SelectedItem as ClientesVo).Bairro;
                txt_Complemento.Text = (cb_Cliente.SelectedItem as ClientesVo).Complemento;
                txt_Data.Text = (cb_Cliente.SelectedItem as ClientesVo).DtCadastro.ToString();
                txt_Email.Text = (cb_Cliente.SelectedItem as ClientesVo).Email;
                txt_Endereco.Text = (cb_Cliente.SelectedItem as ClientesVo).Rua;
                txt_Nome.Text = (cb_Cliente.SelectedItem as ClientesVo).Nome;
                txt_Numero.Text = (cb_Cliente.SelectedItem as ClientesVo).Numero.ToString();
                if (Convert.ToChar((cb_Cliente.SelectedItem as ClientesVo).Sexo) == 'M')
                    rd_Masc.Checked = true;
                else
                    rd_Fem.Checked = true;
                if ((cb_Cliente.SelectedItem as ClientesVo).Ativo)
                    ...
                    rd_Desativo.Checked = true;
                dt_Nascimento.Value = (cb_Cliente.SelectedItem as ClientesVo).DtNasc;
